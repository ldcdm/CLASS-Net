...
class Data_Preprocess:
    ...
    def do_select(self):
        ...
        print(self.bg/60," back")
        print(self.fg/60," fore")
        print(self.fb/60," fb")
        print(self.fc/60," fc")
        print(self.tb/60," tb")
        print(self.tec/60," tec")
        print(self.tic/60," tic")
        print(self.fb1/60," fb1")
        print(self.fc1/60," fc1")
        print(self.tb1/60," tb1")
        print(self.tec1/60," tec1")
        print(self.tic1/60," tic1")
...
if __name__ == '__main__':
    ...
    base_dir =  "/home/dluser/dataset/ZDY_Dataset/dataset/ski10"  #
